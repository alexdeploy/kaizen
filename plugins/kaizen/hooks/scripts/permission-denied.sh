#!/usr/bin/env bash
# kaizen :: hook stub for PermissionDenied
#
# Fires:    Fires when a tool call is denied by the auto-mode classifier
# Payload:  stdin JSON — tool + reason
# Exit 0 = continue.
...
# TODO: implement PermissionDenied logic for kaizen here.
