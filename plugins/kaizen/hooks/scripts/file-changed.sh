#!/usr/bin/env bash
# kaizen :: hook stub for FileChanged
#
# Fires:    Fires when a watched file changes on disk (external editor, etc.)
# Payload:  stdin JSON — file path
# Exit 0 = continue.
...
# TODO: implement FileChanged logic for kaizen here.
