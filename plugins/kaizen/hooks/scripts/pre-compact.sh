#!/usr/bin/env bash
# kaizen :: hook stub for PreCompact
#
# Fires:    Fires BEFORE context compaction starts
# Payload:  stdin JSON — matcher: auto/manual
# Exit 0 = continue.
...
# TODO: implement PreCompact logic for kaizen here.
