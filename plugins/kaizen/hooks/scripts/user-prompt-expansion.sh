#!/usr/bin/env bash
# kaizen :: hook stub for UserPromptExpansion
#
# Fires:    Fires when a user-typed command/skill expands into a prompt
# Payload:  stdin JSON — raw input + expanded prompt
# Exit 0 = continue.
...
# TODO: implement UserPromptExpansion logic for kaizen here.
