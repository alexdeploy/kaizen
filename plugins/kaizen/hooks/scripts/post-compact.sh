#!/usr/bin/env bash
# kaizen :: hook stub for PostCompact
#
# Fires:    Fires AFTER context compaction completes
# Payload:  stdin JSON — compaction stats
# Exit 0 = continue.
...
# TODO: implement PostCompact logic for kaizen here.
