#!/usr/bin/env bash
# kaizen :: hook stub for TeammateIdle
#
# Fires:    Fires when an agent-team teammate goes idle
# Payload:  stdin JSON — teammate info
# Exit 0 = continue.
...
# TODO: implement TeammateIdle logic for kaizen here.
