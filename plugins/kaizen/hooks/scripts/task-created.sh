#!/usr/bin/env bash
# kaizen :: hook stub for TaskCreated
#
# Fires:    Fires when a task is created in TodoWrite
# Payload:  stdin JSON — task content + activeForm
# Exit 0 = continue.
...
# TODO: implement TaskCreated logic for kaizen here.
