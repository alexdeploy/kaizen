#!/usr/bin/env bash
# kaizen :: hook stub for WorktreeCreate
#
# Fires:    Fires when a worktree is being created (via --worktree or EnterWorktree)
# Payload:  stdin JSON — worktree path
# Exit 0 = continue.
...
# TODO: implement WorktreeCreate logic for kaizen here.
