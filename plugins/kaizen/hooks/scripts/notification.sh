#!/usr/bin/env bash
# kaizen :: hook stub for Notification
#
# Fires:    Fires when Claude Code sends a notification (e.g., permission prompt, idle)
# Payload:  stdin JSON — matcher: permission_prompt/idle/etc.
# Exit 0 = continue.
...
# TODO: implement Notification logic for kaizen here.
