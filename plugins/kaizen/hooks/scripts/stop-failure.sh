#!/usr/bin/env bash
# kaizen :: hook stub for StopFailure
#
# Fires:    Fires when a turn ends due to API error
# Payload:  stdin JSON — error details
# Exit 0 = continue.
...
# TODO: implement StopFailure logic for kaizen here.
