#!/usr/bin/env bash
# kaizen :: hook stub for CwdChanged
#
# Fires:    Fires when the working directory changes
# Payload:  stdin JSON — old_cwd + new_cwd
# Exit 0 = continue.
...
# TODO: implement CwdChanged logic for kaizen here.
