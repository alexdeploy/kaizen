#!/usr/bin/env bash
# kaizen :: hook stub for ConfigChange
#
# Fires:    Fires when a configuration file changes during the session
# Payload:  stdin JSON — file path + change type
# Exit 0 = continue.
...
# TODO: implement ConfigChange logic for kaizen here.
