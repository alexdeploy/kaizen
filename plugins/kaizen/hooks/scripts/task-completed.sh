#!/usr/bin/env bash
# kaizen :: hook stub for TaskCompleted
#
# Fires:    Fires when a task is marked completed in TodoWrite
# Payload:  stdin JSON — task info
# Exit 0 = continue.
...
# TODO: implement TaskCompleted logic for kaizen here.
