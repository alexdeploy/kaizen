#!/usr/bin/env bash
# kaizen :: hook stub for Stop
#
# Fires:    Fires when Claude finishes responding (turn end)
# Payload:  stdin JSON — turn completion info
# Exit 0 = continue.
...
# TODO: implement Stop logic for kaizen here.
