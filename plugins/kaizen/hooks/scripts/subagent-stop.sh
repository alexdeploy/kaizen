#!/usr/bin/env bash
# kaizen :: hook stub for SubagentStop
#
# Fires:    Fires when a subagent finishes
# Payload:  stdin JSON — subagent_type + result
# Exit 0 = continue.
...
# TODO: implement SubagentStop logic for kaizen here.
