#!/usr/bin/env bash
# kaizen :: hook stub for PostToolUseFailure
#
# Fires:    Fires after a tool call fails
# Payload:  stdin JSON — tool_name + tool_input + error
# Exit 0 = continue.
...
# TODO: implement PostToolUseFailure logic for kaizen here.
