#!/usr/bin/env bash
# kaizen :: hook stub for PermissionRequest
#
# Fires:    Fires when the permission dialog appears
# Payload:  stdin JSON — requesting tool + pattern
# Exit 0 = continue.
...
# TODO: implement PermissionRequest logic for kaizen here.
