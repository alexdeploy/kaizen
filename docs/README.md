...
This documentation tracks kaizen **v0.9.0** — the v0 skill set is complete; v0.7+ ships polish + UX improvements rather than new skills. Currently shipped commands:
